...
> **Essay** — argument, analysis, perspective on where the global landscape is heading. Reading time 8–12 min.
>
> **Case Study** — deep investigation into real events, threat scenarios, and actual infrastructure in Malaysia and the ASEAN region. Reading time 12–18 min.
...
This series will grow. Format follows the topic — if something needs an argument, it becomes an essay; if there's real data and events to investigate, it becomes a case study.
