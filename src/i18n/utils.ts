 ...
 *   localizedPath('/posts/foo', 'ms') -> '/ms/posts/foo'
 *   localizedPath('/', 'ms')          -> '/ms/'
 *
 ...
 * Anything starting with `/ms` or `/ms/` resolves to 'ms'; otherwise
 ...
 *
 *   stripLocale('/ms/posts/foo')  -> '/posts/foo'
